...
from src.app.core.database import (
    ensure_gold_individual_learning_summary_view,
    ensure_gold_registered_user_learning_summary_view,
    ensure_gold_team_learning_summary_view,
    engine,
    ensure_gold_user_learning_summary_view,
    ensure_moodle_course_activities_view,
    ensure_moodle_identity_map_view,
    ensure_moodle_log_bronze_columns,
    ensure_moodle_silver_learning_events_view,
